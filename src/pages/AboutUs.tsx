const AboutUs = () => {
  ...
  return(
    ...
    <h3 className="about-us-title">EXQUISITE CRAFTSMANSHIP</h3>
      ...
      <p className="about-us-text">All BDSM tools in our kits are made from premium cowhide imported from Italy, crafted by skilled artisans to ensure high quality and exceptional user experience. The metal components are custom-molded, with some pieces featuring gold-plated brass, offering a tangible sense of weight and precision.</p>
      <p className="about-us-text">Although UPKO initially established itself in the BDSM niche, we do not limit ourselves to any specific definition. Like traditional sex toys, our tools help everyone explore their bodies and intimate relationships, offering thoughtful assistance along the way.
